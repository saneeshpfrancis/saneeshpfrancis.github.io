      ...
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              {profile.title} — {profile.organisation}. Making laboratory
              science accessible through technology.
            </p>
          </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-border/70 pt-6 text-xs text-muted-foreground sm:flex-row">
          ...
          <p className="inline-flex items-center gap-1.5">
            Built with{" "}
            <Heart className="h-3.5 w-3.5 fill-rose-500 text-rose-500" /> using
            React.
          </p>
        </div>
      </div>
